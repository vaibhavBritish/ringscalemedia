...
const IphoneIpadDevelopment = () => {
  ...
  const ApplicationDev = [
    { id: 1, title: "Iphone Apps.", desc: "Digital | Mobile | CLM Experiental" },
    { id: 2, title: "Ipad Apps.", desc: "Scientific Storytelling / MLR Standards | Identity" },
    { id: 4, title: "Apple TV Apps.", desc: "Scientific Storytelling / MLR Standards | Identity" },
    { id: 3, title: "Apple Watch Apps.", desc: "Health & Fitness | Lifestyle | Productivity" },
    { id: 5, title: "Other iOS Apps.", desc: "Tailored Solutions | Business Needs | User Experience" },
    { id: 6, title: "Gaming Apps", desc: "Digital | Mobile | CLM Experiental" },
  ]
  return (
    <div>
      <WhatWeDoLayout children="iPhone/iPad App Development">
      </WhatWeDoLayout>

      <section className='max-w-6xl mx-auto'>
        <div className='px-4 py-16'>
          <p>Are you in a hunt for an iPhone/iPad application development company? If yes, stop looking further as we will assist you expand your reach to millions of Apple users across the globe. With our app development services, we will let you make the most out of your iPhone/iPad. We strive hard to bring out most useful as well as fascinating products for your iOS audience. Our services will indeed let you stand out among others in this competitive market. We have a number of years of experience in building dozens of applications for different operating systems.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="w-full lg:w-1/2 text-white">
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                LET&apos;S FIND OUT WHAT WE OFFER
              </h2>

              <p className="text-red-500 mb-6">
                Our services cover the whole range of Apple Family including the following:
              </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-4 leading-relaxed">
              Working with <strong>Ring Scale Media</strong>, you will always find your
              business at the top level. Our team carefully understands what customers
              desire and expect. We merge your ideas with our creative technology to
              transform your vision into a successful product.
            </p>
      ...
      <section className="max-w-6xl mx-auto px-4 py-20">
        <div className="text-center">
          <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 leading-tight">
            ...
            <span className="text-blue-600">DEVELOPMENT PROFICIENCY</span>
          </h1>

          <p className="mt-4 max-w-2xl mx-auto text-gray-600 text-lg">
            Looking for a professional team to develop a high-quality iPhone or iPad application?
            Our experts are here to turn your ideas into reality.
          </p>
      ...
      <section className="relative bg-black text-white overflow-hidden py-24">
        <h2 className="text-center text-3xl md:text-5xl font-extrabold tracking-wide">
          ...
          <span className="text-white">BUILD IOS APPS</span>
        </h2>
        ...
        <div className="max-w-6xl mx-auto px-6 mt-20 grid grid-cols-1 lg:grid-cols-3 items-center gap-12">
          ...
          <div className="space-y-6 text-gray-300 text-sm md:text-base leading-relaxed">
            <p>
              To keep up with the trend, we use latest and high-end technologies
              to develop the app of your choice.
            </p>

            <p>
              We always use most reliable as well as efficient tools to build
              your iPhone/iPad applications.
            </p>

            <p>
              With technologies like <span className="text-white font-semibold">HealthKit, iCloud</span> and
              <span className="text-white font-semibold"> CloudKit</span>, we deliver you
              the best of app experiences.
            </p>
          </div>
          ...
          <div className="space-y-6 text-gray-300 text-sm md:text-base leading-relaxed">
            <p>
              Our application development team also uses trending and novel
              technologies such as <span className="text-white font-semibold">Apple Pay, WebKit</span>, and
              <span className="text-white font-semibold"> ARKit</span>.
            </p>

            <p>
              Our team also uses a toolset such as Apple’s
              <span className="text-white font-semibold"> Xcode, Sketch, Figma, Flutter</span>,
              MarvelApp, and more.
            </p>

            <p>
              Apart from this, we also use latest technologies such as
              <span className="text-white font-semibold"> PassKit, Realm, SwiftUI</span>,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 leading-snug">
              Expand Your Reach in the <span className="text-blue-600">Apple Market</span>
              <br /> Before It’s Too Late
            </h2>

            <p className="mt-4 text-gray-600 leading-relaxed max-w-lg">
              Partner with a trusted iOS development team that helps you
              reach more Apple users, increase engagement, and grow your
              business with scalable and secure applications.
            </p>
...
export default IphoneIpadDevelopment