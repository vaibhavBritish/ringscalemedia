...
const SocialMediaManagement = () => {
    ...
    return (
        <div>
            <WhatWeDoLayout children="SOCIAL MEDIA MANAGEMENT" >
            </WhatWeDoLayout>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-14">
                     ...
                     hover:shadow-2xl hover:-translate-y-2 transition-all duration-300"
                            >
                                ...
                                <div className="absolute inset-x-0 top-0 h-1 bg-linear-to-r from-blue-500 to-purple-500 rounded-t-2xl opacity-0 group-hover:opacity-100 transition" />
            ...
            <section className="relative bg-black text-white overflow-hidden py-24">
                ...
                <div className="absolute left-6 top-1/2 -translate-y-1/2 h-64 w-0.5 bg-linear-to-b from-pink-500 to-transparent" />
                <div className="absolute right-6 top-1/2 -translate-y-1/2 h-64 w-0.5 bg-linear-to-b from-pink-500 to-transparent" />
            </section>
